...
/* RoutineTabButton removed (now in RoutineComponents.tsx) */
...
const RoutineSection = ({ routine, t, activeTab, setActiveTab, activeSteps, completedSteps, onToggleStep }: RoutineSectionProps) => (
  <div style={{ marginTop: 32 }}>
    ...
    <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
      <RoutineTabButton tab="morning" activeTab={activeTab} onClick={() => setActiveTab('morning')} count={routine.morning.length} t={t} />
      <RoutineTabButton tab="night" activeTab={activeTab} onClick={() => setActiveTab('night')} count={routine.night.length} t={t} />
    </div>
